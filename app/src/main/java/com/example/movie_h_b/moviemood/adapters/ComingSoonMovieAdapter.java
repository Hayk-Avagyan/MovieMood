...
import com.example.movie_h_b.moviemood.fragments.ComingSoonFragment;
import com.example.movie_h_b.moviemood.fragments.SelectedMovieFragment;
import com.example.movie_h_b.moviemood.models.ComingSoonMovies;
...
public class ComingSoonMovieAdapter extends RecyclerView.Adapter<ComingSoonMovieAdapter.MyViewHolder> {
    ...
    private List<ComingSoonMovies> movieList;
    private Context context;
    private ComingSoonFragment comingSoonFragment;

    public ComingSoonMovieAdapter(Context context, ComingSoonFragment comingSoonFragment) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.coming_soon_movie, parent, false);
        MyViewHolder myViewHolder = new MyViewHolder(view);
        return myViewHolder;
    }

    public void addAllComingSoon(List<ComingSoonMovies> movieList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentManager fragmentManager = comingSoonFragment.getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                Bundle bundle = new Bundle();
                bundle.putInt("movie_id_soon", id);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.coming_soon_poster);
            textView = itemView.findViewById(R.id.coming_soon_title);
